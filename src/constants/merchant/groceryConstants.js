 ...
 * delivery orders. Includes wallet operations, staff management, gamification, and compliance.
...
module.exports = {
  ...
  // Staff Management
  STAFF_CONSTANTS: {
    ROLES: ['stock_clerk', 'manager', 'cashier'],
    PERMISSIONS: ['process_orders', 'update_inventory', 'view_analytics', 'manage_staff', 'stock_shelves', 'process_payments'],
    TASK_TYPES: ['stock_shelves', 'update_inventory', 'process_checkout']
  },

  // Gamification
  GAMIFICATION_CONSTANTS: {
    STAFF_ACTIONS: {
      INVENTORY_UPDATE: { action: 'inventory_update', points: 10, roles: ['stock_clerk'] },
      SHELF_STOCKING: { action: 'shelf_stocking', points: 10, roles: ['stock_clerk'] },
      CHECKOUT_PROCESSING: { action: 'checkout_processing', points: 10, roles: ['cashier'] },
      TASK_COMPLETION: { action: 'task_completion', points: 10, roles: ['stock_clerk', 'cashier'] }
    },
