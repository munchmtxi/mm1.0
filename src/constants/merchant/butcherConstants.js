 ...
 * butcherConstants.js
 *
 * Defines constants for the Butcher merchant type, supporting meat preparation and pickup
 * orders. Includes wallet operations, staff management, gamification, and compliance.
...
module.exports = {
  ...
  // Staff Management
  STAFF_CONSTANTS: {
    ROLES: ['butcher', 'manager'],
    PERMISSIONS: ['process_orders', 'update_inventory', 'view_analytics', 'manage_staff', 'prepare_meat'],
    TASK_TYPES: ['prepare_meat', 'update_inventory']
  },

  // Gamification
  GAMIFICATION_CONSTANTS: {
    STAFF_ACTIONS: {
      TIMELY_PREP: { action: 'timely_prep', points: 15, roles: ['butcher'] },
      INVENTORY_UPDATE: { action: 'inventory_update', points: 10, roles: ['butcher'] },
      MEAT_PREPARATION: { action: 'meat_preparation', points: 15, roles: ['butcher'] },
      TASK_COMPLETION: { action: 'task_completion', points: 10, roles: ['butcher'] }
    },
